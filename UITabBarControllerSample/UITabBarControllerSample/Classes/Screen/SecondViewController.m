...
- (void)viewDidLoad
{
    ...
    UILabel *titleLabel = [DCLabel planeLabel:TITLE_RECT
                                         text:@"SecondViewController" font:[UIFont fontWithName:@"Helvetica" size:20]
    ...
    UIButton *transitionButton = [DCButton planeButton:BTN_RECT
                                                  text:@"Go to ThirdViewController"
                                              delegate:self action:@selector(transitionButtonTapEvent:) tag:THIRD_ID];
