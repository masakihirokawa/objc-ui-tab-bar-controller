...
- (void)viewDidLoad
{
    ...
    UILabel *titleLabel = [DCLabel planeLabel:TITLE_RECT
                                         text:@"FirstViewController" font:[UIFont fontWithName:@"Helvetica" size:20]
    ...
    UIButton *transitionButton = [DCButton planeButton:BTN_RECT
                                                  text:@"Go to SecondViewController"
                                              delegate:self action:@selector(transitionButtonTapEvent:) tag:SECOND_ID];
